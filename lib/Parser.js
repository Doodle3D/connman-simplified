...
Parser.parseService = function(rawService) {
  ...
  service.ipaddress = '';
  if (rawService.iPv4 !== undefined && rawService.iPv4.Address !== undefined) {
    service.ip4address = rawService.iPv4.Address;
  }
  if (rawService.iPv6 !== undefined && rawService.iPv6.Address !== undefined) {
    service.ip6address = rawService.iPv6.Address;
  }
  return service;
};
